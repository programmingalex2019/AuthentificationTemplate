...
import 'package:authentification/screens/email_signIn/email_signIn_bloc_based.dart';
import 'package:authentification/screens/sign_in_bloc.dart';
...
class SignScreen extends StatelessWidget {
  ...
  const SignScreen({Key key, @required this.bloc}) : super(key: key);
  ...
  static create(BuildContext context) {
    ...
    return Provider<SignInBloc>(
        ...
        child: Consumer<SignInBloc>(builder: (context, bloc, _) => SignScreen(bloc: bloc)));
  }
  ...
  void _goToSignInForm(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => EmailSignInFormBlocBased.create(context)));
  }
